...
if __name__ == "__main__":
    ...
    prefix1 = "vanilla1,res32x4/student_"
    prefix2 = "vanilla2,res32x4/student_"
    prefix3 = "vanilla3,res32x4/student_"
...
# load vanilla1 and vanilla2
    ...
    plt.title('Norm-2 vs. Epoch(res32x4)')
    plt.xlabel('Epoch')
    plt.ylabel('Norm-2')
    plt.legend()
    plt.show()
    ...
    plt.plot(np.arange(1,61),train_loss_values1,label='resnet32x4-1')
    ...
    plt.plot(np.arange(1, 61), train_loss_values2,label='resnet32x4-2')
